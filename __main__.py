...
from core_ui import Editor, InspectResults, Audit
from core_ui import Core_UI
from SEO import Local, Agency
...
BackDataHandler = getBackSEODataHandler()  # type: BackSEODataHandler
job_queue = BackDataHandler.getJobQ()  # type: Queue
result_queue = BackDataHandler.getRQ()  # type: Queue


def baddy(l: multiprocessing.Lock):
    global lock
    lock = l
