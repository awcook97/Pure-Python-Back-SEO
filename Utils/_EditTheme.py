...
class EditTheme():
	"""
		EditTheme adds the theme menu item to your application that is using dearpygui as the GUI. Just insert the code 
		myTheme = EditTheme() in your dpg.menu_bar or dpg.viewport_menu_bar

		This feature enables you to change all of the colors in the theme and save them to an ini file. 
	"""
	...
	def createMenu(self):
		pluginMenu = dpg.add_menu(label="Theme", parent=self.parent)
		self.loadTheme()
		self.saveTheme()
		self.editTheme()
	...
	def loadAll(self, a=None, sentFileDict={None}, *args, **kwargs):
		try:
			#self.confParser = configparser.ConfigParser()
			#print(sentFileDict)
	...
	def loadTheme(self, *args, **kwargs):
		try:
	...
	def saveTheme(self, *args, **kwargs):
		try:
		...
		return
	def saveAll(self, a, b, *args, **kwargs):
		"""
	...
	def getThemeColor(self, themeCol, *args, **kwargs):
		"""
	...
	def parse_color_operation(self, operation: str, *args, **kwargs):
	...
	def all_saved_colors(self, *args, **kwargs):
		self.theColors = [
			"mvThemeCol_Text",
